...
export const FROG_IMG = frogImg;
export const BG_IMG = bgImg;
export const BG_V2_IMG = bgWithoutLilypadImg;
export const LILYPAD_IMG = lilypadImg;
export const START_LABEL_IMG = startLabelImg;
